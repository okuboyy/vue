...
<template>
  <div class="space-y-2">
    <div class="group relative space-y-3">
      <div
        class="w-full min-h-80 bg-gray-200 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:h-80 lg:aspect-none"
      >
        <img
        ...
        <div>
          <h3 class="text-sm text-gray-700">
            <a :href="props.product.href">
              <span area-hidden="true" class="absolute inset-0" />{{
                props.product.name
              }}</a
            >
          </h3>
